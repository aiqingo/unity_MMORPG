...
public class UIManager : Singleton<UIManager>
{
    ...
    public UIManager()
    {
        ...
        this.UIResources.Add(typeof(UISyayemConfig), new UIElement() { Resources = "UI/UISystemConfig", Cache = false });
    }
    ...
    public T Show<T>()
    {
        SoundManager.Instance.PlaySound(SoundDefine.SFX_UI_Win_Opon);
        Type type = typeof(T);
