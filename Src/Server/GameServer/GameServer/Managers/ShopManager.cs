...
namespace GameServer.Managers
{
    class ShopManager:Singleton<ShopManager>
    {
        ...
        {
            if (Equals(!DataManager.Instance.Shops.ContainsKey(shopId)))
            {
            ...
            {
                Log.InfoFormat("BuyItem: :character: 0 : Item: [1) Count: [2) Price: [3)", sender.Session.Character.Id,
                    shopItem.ItemID, shopItem.Count, shopItem.Price);
